# Yet Another Mechlab - A Mechwarrior 5 Mod
...
| `optimalRangeMulti`      ||
| `maxRangeMulti`          ||
| `jamChanceMulti`         |Weapons can have a jam chance between 0 and 1 with 1 refering to a 100% jam chance. This multi will be applied to the weapon's jam chance.|
